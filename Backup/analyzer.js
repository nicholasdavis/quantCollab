class Analyzer{
	...
	this.collaborationDynamicLabels = {
		...
		"player1AcceptCountLabel": this.player2AcceptCountLabel, 
	...
	calculateCollaborationType(){
		...
		//xconsole.log("P2AcceptCount Label: " + this.collaborationDynamicLabels.player2AcceptCountLabel); 
		...
		if(this.player1AcceptCountLabel == "low" & this.player2AcceptCountLabel == "low"){
			...
			this.collaborationType = "Leader & Follower Collaboration"; 
		}else{
