...
//Interaction Dynamics 
		  ...
		  document.getElementById("player1Offers").innerHTML = "Drawing Offers: " + this.analyzer.player1Offers;
		  document.getElementById("player1OffersAccepted").innerHTML = "Offers Accepted: " + this.analyzer.player1InitiateCouplingCount;
		  document.getElementById("player1OffersRejected").innerHTML = "Offers Rejected: " + (this.analyzer.player2Offers - this.analyzer.player1InitiateCouplingCount);
		  document.getElementById("player1TurnsMimicked").innerHTML = "Turns Mimicked: " + this.analyzer.player1SimilarLineCount;
		  document.getElementById("player1CoupledTurnBasedOnOffer").innerHTML = "Coupled Turns Based on Offers: " + this.analyzer.player1CoupledStartedCount;
		  document.getElementById("player1AvgCoupleFounded").innerHTML = "Avg Turns Per Accepted Offer: " + this.analyzer.player1CoupleFoundedAvgDepth.toFixed(1);


		  document.getElementById("player2Name2").innerHTML = "Player: " + this.analyzer.player2.name;
		  document.getElementById("player2Offers").innerHTML = "Drawing Offers: " + this.analyzer.player2Offers;
		  document.getElementById("player2OffersAccepted").innerHTML = "Offers Accepted: " + this.analyzer.player2InitiateCouplingCount;
		  document.getElementById("player2OffersRejected").innerHTML = "Offers Rejected: " + (this.analyzer.player1Offers - this.analyzer.player2InitiateCouplingCount);
		  document.getElementById("player2TurnsMimicked").innerHTML = "Turns Mimicked: " + this.analyzer.player2SimilarLineCount;
		  document.getElementById("player2CoupledTurnBasedOnOffer").innerHTML = "Coupled Turns Based on Offers: " + this.analyzer.player2CoupledStartedCount;
		  document.getElementById("player2AvgCoupleFounded").innerHTML = "Avg Turns Per Accepted Offer: " + this.analyzer.player2CoupleFoundedAvgDepth.toFixed(1);
